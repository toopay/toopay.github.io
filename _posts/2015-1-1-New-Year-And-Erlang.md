...
So for 2015, I will enjoy spending this whole year diving more deep to Erlang. I will wrote more Erlang, probably roll out some new oper-source library (for Erlang), and continue to building my OTP application that utilize awesome community libraries, just to mention a few : [ejabberd](https://github.com/processone/ejabberd), [ranch](https://github.com/ninenines/ranch) and [riak](https://github.com/basho/riak). I know when i get stuck, and [throw a question to the community](http://stackoverflow.com/questions/27229185/riak-data-types-and-search), the community will gladly help. FYI, they are surprisingly very warm and cheerful, also if i must added here : had a good sense of humor. If a community around your language are nothing but either language elitist (which you can easiliy found in some of the worst language community) nor those people who spend most of their time talking about framework or language war, you probably want to try Erlang and mingle with their community. You off course, will found me, with the smile of a curious little one year old girl bringing her new amazing toy everywhere she go.